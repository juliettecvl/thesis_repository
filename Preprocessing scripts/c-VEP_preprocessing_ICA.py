...
save_dir = '/Users/juliette/Desktop/thesis/preprocessing/c-VEP_preprocessing/c-VEP_ICA'
...
for sub in subjects:
    fn = os.path.join(ica_dir, f"sub-{sub}", f"sub-{sub}_bad_elec.csv")
...
for i_subject, subject in enumerate(subjects):
    ...
    for i_task, task in enumerate(tasks):
        ...
        np.savez(os.path.join(save_dir, f"sub-{subject}_task-{task}_ICA.npz"), X=X, y=y, z=z, V=V, fs=fs)
