...
Modified by Juliette van Lohuizen (juliette.vanlohuizen@ru.nl) to include changes concerning ICA application,
channel removal, and preprocessing specific to P300.
"""
...
save_dir = '/Users/juliette/Desktop/thesis/preprocessing/p300_preprocessing/p300_ICA'
...
for subject in subjects:
    ...
    for task in tasks:
        ...
        np.savez(os.path.join(save_dir, f"sub-{subject}_task-{task}_p300_ICA.npz"), X=X, y=y, z=z, V=V, fs=fs)
